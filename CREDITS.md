...
Prior art and references, no code used:
[frontend-sdl-cpp](https://github.com/projectM-visualizer/frontend-sdl-cpp) (official
projectM frontend, GPL-3.0), [ProjectMilkSyphon](https://github.com/Vidvox/projectM-Syphon)
by Vidvox, [Butterchurn](https://github.com/jberg/butterchurn) by Jordan Berg,
[Webamp](https://github.com/captbaritone/webamp) by Jordan Eldredge.

libprojectM statically includes projectm-eval (MIT), hlslparser (MIT), GLM (MIT), and
SOIL2 (public domain). Details in [THIRD-PARTY-NOTICES.md](THIRD-PARTY-NOTICES.md).
